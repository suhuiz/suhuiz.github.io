...
## 2.1 Page 1: Exploratory Data (EDA)
...
## 2.2 Page 2: Confirmatory Data (CDA)
...
## 2.3 Page 3: Customer Segmentation
...
## 2.5 Page 5: Ecosystem Cash Flow
...
## 2.6 Page 6: Predictive Risk Simulator
...
Data without meaningful interpretation often becomes noise rather than insight. The FinRetain storyboard illustrates the full lifecycle of a FinTech customer, from their initial engagement with the platform to the potential risk of churn. Through this narrative structure, our visual analytics dashboard demonstrates how stakeholders can identify critical behavioral patterns and intervene at the right moments.

## 3.1 Introduction

The FinRetain project transforms complex, high-dimensional transactional data into a clear visual narrative of customer behavior, financial activity, and churn risk. Rather than analyzing isolated metrics, the storyboard presents a comprehensive view of the customer lifecycle. This approach allows analysts and decision-makers to understand patterns across different stages of user engagement and generate actionable insights.

## 3.2 Motivation

In the competitive FinTech industry, customer acquisition is costly, while long-term retention generates sustainable profitability. Despite this, many platform managers face a significant limitation. They can observe when users leave the platform but often lack the ability to identify the behavioral signals that precede churn.

FinRetain aims to shift this process from reactive reporting to proactive and predictive visual analytics. Specifically, the platform is designed to address three key questions:
...
## 3.4 A Customer Journey

### 3.4.1 Scene 1: Onboarding and Demographic Baseline (EDA)
...
### 3.4.2 Scene 2: Understanding Behavioral Relationships (CDA)
...
### 3.4.3 Scene 3: Identifying Customer Personas (Customer Segmentation)
...
### 3.4.4 Scene 4: The Ticking Clock of Retention (Survival Timeline)
...
### 3.4.5 Scene 5: Mapping the Financial Ecosystem (Ecosystem Cash Flow)
...
### 3.4.6 Scene 6: Simulating the Future (Predictive Risk Simulator)
...
### **4.1.1 Installing and loading the required libraries**
...
## 4.3 Confirmatory Data (CDA)

### 4.3.1 Macro Correlation Matrix
...
### 4.3.2 Statistical Hypothesis Testing (Spearman)
...
### 4.4.1 Algorithmic Personas (K-Means Clustering)
...
### 4.4.2 Value Stratification (Treemap)
